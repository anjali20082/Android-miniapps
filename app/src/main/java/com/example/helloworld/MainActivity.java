...
public class MainActivity extends AppCompatActivity implements  SensorEventListener,LocationListener  {
    ...
    Location l;
    private SensorEventListener mSensorListeneracc, mSensorListenerlinacc, mSensorListenerlight, mSensorListenertemp,mSensorListenerprox;
...
//                    registersensor(mAcc);
                    mSensorManager.registerListener(mSensorListeneracc, mAcc, SensorManager.SENSOR_DELAY_NORMAL);
                }else if(!isChecked)
                {
                    mSensorManager.unregisterListener(mSensorListeneracc,mAcc);
//                   unregistersensor(mAcc);
        ...
        linaccbtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {

            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    Log.v("Switch State=", "" + isChecked);
//                    registersensor(mLinAcc);
                    mSensorManager.registerListener(mSensorListeneracc, mLinAcc, SensorManager.SENSOR_DELAY_NORMAL);
                }else if(!isChecked)
                {
                    mSensorManager.unregisterListener(mSensorListeneracc,mLinAcc);
//                    unregistersensor(mLinAcc);
                }
        ...
        lightbtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    Log.v("Switch State=", "" + isChecked);
//                    registersensor(mSensorLight);
                    mSensorManager.registerListener(mSensorListeneracc, mSensorLight, SensorManager.SENSOR_DELAY_NORMAL);
                }else if(!isChecked)
                {
                    mSensorManager.unregisterListener(mSensorListeneracc,mSensorLight);
//                    unregistersensor(mSensorLight);
                }
        ...
        tempbtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    Log.v("Switch State=", "" + isChecked);
//                    registersensor(mSensorTemp);
                    mSensorManager.registerListener(mSensorListeneracc, mSensorTemp, SensorManager.SENSOR_DELAY_NORMAL);
                }else if(!isChecked)
                {
                    mSensorManager.unregisterListener(mSensorListeneracc,mSensorTemp);
//                    unregistersensor(mSensorTemp);
                }

            }
        });

        proxbtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {

            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    Log.v("Switch State=", "" + isChecked);
//                    registersensor(mSensorProximity);
                    mSensorManager.registerListener(mSensorListeneracc, mSensorProximity, SensorManager.SENSOR_DELAY_FASTEST);
                }else if(!isChecked)
                {
                    mSensorManager.unregisterListener(mSensorListeneracc,mSensorProximity);
//                    unregistersensor(mSensorProximity);
                }
        ...
        gpsbtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
...
public boolean registersensor(Sensor s){
        return mSensorManager.registerListener(mSensorListeneracc,s,SensorManager.SENSOR_DELAY_NORMAL);

}
public void unregistersensor(Sensor s){

    mSensorManager.unregisterListener(mSensorListeneracc,s);
}
