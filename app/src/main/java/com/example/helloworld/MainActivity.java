...
public class MainActivity extends AppCompatActivity implements  SensorEventListener,LocationListener, CompoundButton.OnCheckedChangeListener  {
...
//            return;
        ...
        if (isgpsenabled && gpsbtn.isChecked()) {
...
//
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        switch (buttonView.getId()) {
            ...
            case R.id.LinAccSwitch:
                if (isChecked) {
                    Log.v("Switch State=", "" + isChecked);
                    mSensorManager.registerListener(this, mLinAcc, SensorManager.SENSOR_DELAY_NORMAL);
                } else if (!isChecked) {
                    mSensorManager.unregisterListener(this, mLinAcc);
                    mTextLinaccx.setText(" ");
                    mTextLinaccy.setText(" ");
                    mTextLinaccz.setText(" ");
                }
                break;
            ...
            case R.id.ProxSwitch:
                ...
                break;
            case R.id.TempSwitch:
                if (isChecked) {
                    Log.v("Switch State=", "" + isChecked);
                    mSensorManager.registerListener(this, mSensorTemp, SensorManager.SENSOR_DELAY_NORMAL);
                } else if (!isChecked) {
                    mSensorManager.unregisterListener(this, mSensorTemp);
                    mtexttemp.setText(" ");
